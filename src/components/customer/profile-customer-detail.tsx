    ...
    return(
        <div className='flex flex-col gap-[1rem] px-[1rem] lg:px-[2rem] items-center'>
            <div className='flex flex-col p-[1rem] justify-center items-center rounded-[1rem] shadow-md w-full'>
                <img src={currentSession?.user.profile?.img_profile || "/cow-not-found.png"} className='mb-[2rem] w-[10rem] lg:w-[12rem] shadow-md rounded-[1rem] h-[15rem] lg:h-[17rem] object-cover' />
                <Upload
                    accept="image/*"
                    beforeUpload={(file) => {
                        handleUpload(file);
